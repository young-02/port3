                ...
                <article class="content-article">
                    <div class="login-form">
                        ...
                        <?php
                            ...
                            $sql = "INSERT INTO myMember01(youEmail, youName, youPass, youBirth, youNumber, regTime) 
                           ...
                           echo "<pre>";
                            ...
                            $sql = "SELECT youEmail FROM myMember01 WHERE youEmail = '$youEmail'";
                            $result = $connect -> query($sql);
                            ...
                            $sql = "SELECT youNumber FROM myMember01 WHERE youNumber = '$youNumber'";
                            $result = $connect -> query($sql);
